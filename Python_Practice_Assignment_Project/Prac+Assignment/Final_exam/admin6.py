# Admin⇒ # 6.Can on or off the loan feature of the bank.      
...
class Admin(User):
    ...
    def available_balance(self):
        total = self.total_accounts[0].currenBalance
        print(f"Total balance bank: {total}")   
    ...
    def total_loan_amount(self):
        ...
        print(f"Total balance bank: {total_loan}")  
