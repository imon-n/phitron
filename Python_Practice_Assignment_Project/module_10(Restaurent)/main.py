...
def main():
    menu = Menu()
    pizza_1 = Pizza('suktki pizaa', 6000, 'large',['sukti', 'onion'])
    ...
    restaurant = Restaurant('safron', 20000, menu)
  ...
  # customer 1 placing an order
    customer_1 = Customer('sakib',6,'jj@gnail.com','boyra',6000)
    order_1 = Order(customer_1, [pizza_3, coke, burger_1, pizza_3, coffee])

    customer_1.pay_for_order(order_1,5000)
    ...
    customer_2.pay_for_order(order_2,555)
