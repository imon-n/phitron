...
# cheak the class intregation

niye_jao = Ride_sharing('Niye jau')

sakib = Rider('Sakib khan', 'sakib@khan.com', 1254, 'mohakali', 1200)
niye_jao.add_rider(sakib)

kala_paki = Driver('kala pakhi', 'kala@sada.com', 5648, 'gullsan 1')
niye_jao.add_drivers(kala_paki)
